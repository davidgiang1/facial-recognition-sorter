# Development Guide: Facial Recognition Sorter

This document outlines the technical architecture, project structure, and algorithms behind the Facial Recognition Sorter. For general usage instructions, please see `README.md`.
